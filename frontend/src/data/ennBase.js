...
export const ENN_BASE = {
  "1w9": {
    ...
    "growthSummary": "Counter's threat output says: Relaxing the standard produces irreversible damage. The growth direction is that prediction being falsified — satisfaction in something as it is, arriving without correction. Each arrival revises how bad, how likely and how soon, never the structure underneath."
  },
  "1w2": {
  ...
  "2w1": {
    ...
    "growthSummary": "Counter's threat output says: Without providing, no one will want me for what I am. The growth direction is that prediction being falsified — being sought for interiority rather than utility. Each arrival revises how bad, how likely and how soon, never the structure underneath."
  },
  "2w3": {
  ...
  "3w2": {
    ...
    "growthSummary": "Counter's threat output says: Non-performance cascades to material and relational collapse. The growth direction is that prediction being falsified — support arriving without performing for it; structures holding during non-performance. Each arrival revises how bad, how likely and how soon, never the structure underneath."
  },
  "3w4": {
  ...
  "4w3": {
    ...
    "growthSummary": "Counter's threat output says: I am too broken to sustain ordinary commitments. The growth direction is that prediction being falsified — consistent principled functioning available while the deficiency feeling persists. Each arrival revises how bad, how likely and how soon, never the structure underneath."
  },
  "4w5": {
  ...
  "5w4": {
    ...
    "growthSummary": "Counter's threat output says: Engagement will drain me to nothing. The growth direction is that prediction being falsified — direct engagement generating rather than depleting energy. Each arrival revises how bad, how likely and how soon, never the structure underneath."
  },
  "5w6": {
  ...
  "6w5": {
    ...
    "growthSummary": "Counter's threat output says: Relaxing monitoring lets catastrophe arrive undetected. The growth direction is that prediction being falsified — rest with vigilance suspended; things hold without monitoring. Each arrival revises how bad, how likely and how soon, never the structure underneath."
  },
  "6w7": {
  ...
  "7w6": {
    ...
    "growthSummary": "Counter's threat output says: Committing to one thing exhausts all exits. The growth direction is that prediction being falsified — depth that is spacious rather than trapping. Each arrival revises how bad, how likely and how soon, never the structure underneath."
  },
  "7w8": {
  ...
  "8w7": {
    ...
    "growthSummary": "Counter's threat output says: Tenderness will be weaponized against me. The growth direction is that prediction being falsified — care given returning as care rather than leverage. Each arrival revises how bad, how likely and how soon, never the structure underneath."
  },
  "8w9": {
  ...
  "9w8": {
    ...
    "growthSummary": "Counter's threat output says: Asserting myself damages the field beyond repair. The growth direction is that prediction being falsified — assertion deepening connection; mattering welcomed. Each arrival revises how bad, how likely and how soon, never the structure underneath."
  },
  "9w1": {
